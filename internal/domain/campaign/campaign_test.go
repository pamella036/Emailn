...
func Test_NewCampaign_MustValidateNameMax(t *testing.T) {
	...
	assert.Equal("name is required with max24", err.Error())
}
...
func Test_NewCampaign_MustValidateContentMax(t *testing.T) {
	...
	assert.Equal("content is required with max1024", err.Error())
}

func Test_NewCampaign_MustValidateContentMin(t *testing.T) {
	assert := assert.New(t)

	_, err := NewCampaign(name, "abc", contacts, createdBy)

	assert.Equal("content is required with min5", err.Error())
}
...
func Test_NewCampaign_MustValidateCretedBy(t *testing.T) {
	assert := assert.New(t)
